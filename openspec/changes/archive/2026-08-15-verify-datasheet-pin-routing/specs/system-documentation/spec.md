...
The system SHALL provide complete technical documentation in the project repository covering hardware wiring, GPIO mappings verified against the ESP32-S3 datasheet, FreeRTOS task architecture, Modbus RTU register mapping, PID controller tuning, and test suites.
