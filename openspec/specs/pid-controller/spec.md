...
## Purpose
Specifies the discrete PID controller module for linear actuator position regulation in C, including derivative action on measurement, 1st-order IIR low-pass filtering, conditional anti-windup integration, in-position deadband, numerical guardrails against NaN/INF/dt<=0, and reset functionality.
