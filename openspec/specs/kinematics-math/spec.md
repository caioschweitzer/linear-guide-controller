...
## Purpose
Specifies the hardware-decoupled linear kinematics math module responsible for encoder count to millimeter conversion, zero homing offset calibration, differential velocity estimation, low-pass EMA noise filtering, and Modbus fixed-point integer serialization.
