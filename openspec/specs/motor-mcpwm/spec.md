...
## Purpose
Specifies the ESP32-S3 hardware MCPWM motor driver for 20 kHz PWM generation, L298N H-bridge direction control (IN1/IN2), direction reversal shoot-through protection (brake phase), effort clamping, and fail-safe numerical protection against NaN/INF.
